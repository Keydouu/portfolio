    ...
    <div class="slides" id="slides">
        <div class="slide">
            ...
            <div class="textHolder">
                <h2>Contexte</h2>
                <p id="txt1-1">BL Optim est un solveur pour les problèmes de planification et d'ordonnancement sous contraintes. Il est utilisé dans divers domaines pour optimiser les tâches et minimiser les coûts.
                ...
                <p id="txt1-2">Un des défis majeurs est la gestion des nombreux paramètres influençant la qualité des solutions obtenues. Adapter ces paramètres est crucial pour optimiser les performances du solveur.</p>
            </div>
        </div>
        <div class="slide">
            <br>
            <div class="textHolder">
                ...
                <p  id="txt2">BL Optim fournit des solutions adaptées aux contraintes spécifiques des problèmes soumis.
        ...
        <div class="slide">
            ...
            <div class="textHolder">
                ...
                <p id="txt3">J'étais chargé de la totalité de ce projet, de la préparation des données à l'intergration du model au solveur actuel.
                ...
                <img src="assets\images\bl-internship-steps.png" alt="étapes suivis" style="height:60vh;">
            </div>
        </div>
        <div class="slide">
            <br>
            <div class="textHolder">
                <h2>Résultats</h2>
                <p id="txt4">Grâce à cette approche, le solveur a amélioré ses performances de manière significative.
